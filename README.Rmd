...
[Preprint on bioRxiv](https://www.biorxiv.org/content/10.1101/2020.11.18.389189v1)
...
Check out the [pre-built references tutorial](https://github.com/immunogenomics/symphony/blob/main/vignettes/prebuilt_references_tutorial.ipynb) for examples of how to map to provided pre-built Symphony references. You can [download pre-built references](https://github.com/immunogenomics/symphony/tree/main/pre-built_references) from the manuscript in the `pre-built_references` directory in this GitHub repo, or on [Zenodo](https://zenodo.org/record/4602302#.YE2NoJNKhTY).
...
Code to reproduce Symphony results from the Kang et al. manuscript will be made available on github.com/immunogenomics/symphony_reproducibility.
