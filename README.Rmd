...
* You can download pre-built references from the [pre-built_references directory](https://github.com/immunogenomics/symphony/tree/main/pre-built_references) in this GitHub repo, or on [Zenodo](https://zenodo.org/record/4602302#.YE2NoJNKhTY).
...
Code to reproduce Symphony results from the Kang et al. manuscript will be made available on [github.com/immunogenomics/symphony_reproducibility](github.com/immunogenomics/symphony_reproducibility).